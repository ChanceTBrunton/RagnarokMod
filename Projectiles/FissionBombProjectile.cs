...
{
    public class FissionBombProjectile : ModProjectile
    {
        public override void SetDefaults()
        {
            projectile.Name = "Fission Bomb";   //Name of the projectile, only shows this if you get killed by it
        ...
        public override void Kill(int timeLeft)
        {
            ...
            int radius = 30;     //this is the explosion radius, the highter is the value the bigger is the explosion
