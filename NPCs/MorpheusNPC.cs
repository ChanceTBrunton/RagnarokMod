...
namespace ExampleMod.NPCs
{
    ...
    public class MorpheusNPC : ModNPC
    {
		...
		public override string GetChat()
		{
            ...
            chat.Add(start + "what good acting." + end);
            ...
            chat.Add(start + "what the Youtube algorithm is. You have to be demonitized yourself.");
            chat.Add(start + "what an Elytra is." + end);
            chat.Add(start + "what happened to Rayman's limbs." + end);
            chat.Add(start + "how hot Sandra Bullock is." + end);
